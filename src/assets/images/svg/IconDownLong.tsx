...
const IconDownLong = ({ color = '#fff', height = 20, width = 20 }: BaseImgSvg) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill={color} viewBox='0 0 320 512'>
