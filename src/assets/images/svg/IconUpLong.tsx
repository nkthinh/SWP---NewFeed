...
const IconUpLong = ({ color = '#fff', height = 20, width = 20 }: BaseImgSvg) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' height={height} width={width} fill={color} viewBox='0 0 320 512'>
